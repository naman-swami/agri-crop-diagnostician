---
name: evapotranspiration-forecasting
description: Modeling Penman-Monteith reference crop evapotranspiration for precision deficit irrigation.
---
...
```json
{
  "skill": "evapotranspiration-forecasting",
  "status": "completed",
  "confidence": 0.95,
  "findings": []
}
